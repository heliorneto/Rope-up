        ...
        <div id="sobre-page">
            ...
            <div id="sobre-general" >
                <div id="introducao-text">
                    ...
                    <p className="text">Acreditamos na utilização da <strong>tecnologia para uma gestão mais inteligente.</strong> Nossos especialistas e desenvolvedores são conectados com grandes universidades do país sempre levando <strong>inovação para seus projetos.</strong></p>
                    <p className="text">Nos movemos pelo <strong>sucesso do cliente,</strong> sempre buscando o resultado e a melhor experiência dentro e fora do projeto.</p>
                </div>
