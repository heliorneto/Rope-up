        ...
        <div id="sobre-page">
            ...
            <div id="sobre-general" >
                <div id="introducao-text">
                    ...
                    <p id="text">Acreditamos na utilização da <strong>tecnologia para uma gestão mais inteligente.</strong> Nossos especialistas e desenvolvedores são conectados com grandes universidades do país sempre levando <strong>para seus projetos.</strong></p>
